...
namespace HMTDPTeamLibraryProject.MainPages {
    
    
    [System.Runtime.InteropServices.ComVisible(false)]
    public partial class Books : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
...
partial void AfterInitializeComponent();
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(Books).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(Books));
        ...
        private string FindResource() {
            string[] resources = typeof(Books).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".Books.g.xaml") || resource.Equals("Books.g.xaml"))) {
                    return resource;
                }
            }
